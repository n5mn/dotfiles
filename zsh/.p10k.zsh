# Generated by Powerlevel10k configuration wizard on 2023-08-13 at 17:18 -04.
...
() {
  ...
  # User stuff
  typeset -g POWERLEVEL9K_USER_DEFAULT_FOREGROUND=$red
 ...
 # Uncomment this for prefix + it will be gray idk how to change the color 
# typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%244F╰─'
 # typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_FOREGROUND=$red
