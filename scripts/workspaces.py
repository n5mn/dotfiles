...
class WorkspaceSelector(Gtk.Window):
    def __init__(self):
        ...
        if not os.path.isfile(colors_json_path):
            print("Error: colors.json not found in script folder:", colors_json_path)
        ...
        with open(colors_json_path, "r") as color_file:
            colors = json.load(color_file)

        # self.current_workspace_color = colors.get("color7")
        # self.workspace_button_color = colors.get("color4")
        # self.workspace_button_focus_color = colors.get("color11")
        self.current_workspace_color = colors["colors"]["color11"]
        self.workspace_button_color = colors["colors"]["color11"]
        self.workspace_button_focus_color = colors["colors"]["color14"]
        # ---------------------------------------------------------------------
